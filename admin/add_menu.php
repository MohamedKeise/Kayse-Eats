...
if (isset($_POST['submit'])) {
    if (empty($_POST['d_name']) || empty($_POST['about']) || $_POST['price'] == '' || $_POST['res_name'] == '') {
        ...
        $fnew = uniqid() . '.' . pathinfo($fname, PATHINFO_EXTENSION);
        ...
        if ($imageInfo) {
            if ($fsize >= 1000000) {
                ...
                $sql = "INSERT INTO dishes(rs_id, title, slogan, price, img) 
                        VALUE('" . $_POST['res_name'] . "', '" . $_POST['d_name'] . "', '" . $_POST['about'] . "', '" . $_POST['price'] . "', '" . $fnew . "')";
                mysqli_query($db, $sql);
            ...
            $error = '<div class="alert alert-danger alert-dismissible fade show">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <strong>Invalid file!</strong> Please upload a valid image file.
                      </div>';
        }
    }
}
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <!-- Start Page Content -->
                    ...
                    <footer class="footer"> © 2024 - KAYSE EATS </footer>
                </div>               
            </div>
        </div>    
    </div>
