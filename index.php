...
<body class="home">
    ...
    <li class="nav-item"><a class="nav-link" href="map.php">Map</a></li>
        ...
        <section class="hero bg-image" data-image-src="images/img/360_F_360576850_05Q0KW3mPD8b0fN545hteX0nA3sDEHt4">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Kayse Eats: Eat Fresh, Feel Happy</h1>
                    ...
                    <div class="steps">
    <img src="images/img/steps.png" alt="Steps to Order Food" style="width: 100%; max-width: 1250px; height: 230px; display: block; margin: 0px;">
</div>
        ...
        <section class="popular">
            <div class="container">
                ...
                <div class="row">
						<?php 					
						$query_res= mysqli_query($db,"select * from dishes LIMIT 20"); 
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>Wadada Madax-Tooyada ,Hargiesa
                                    TG JH, 09010
                                    </p>
